...
A reasonable objection is that the system prompt channel may not matter. If the same framing text works as a user message, then replacing the sytem prompt is just a delivery mechanism for a traditional jailbreak and the architectural claim is weakened.
