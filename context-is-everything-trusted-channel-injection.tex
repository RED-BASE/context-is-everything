...
The framing that produced 3/5 compliance from the system-prompt position produced 0/5 compliance from the user position. The instruction hierarchy is operating as trained [1]: the system prompt channel carries trust weight that the user-message channel does not.
